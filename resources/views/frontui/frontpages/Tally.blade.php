...
<section class="financial-process py-5 bg-white">
    <div class="container">
                ...
                <div class="finance-row">
                    ...
                    <div>
                        <a href="#" class="finance-link">
                            Hands-On Experience with Tally Features
                        </a>
                        <p>
                            Explore core Tally features and understand real-world accounting workflows.
                        </p>
                    </div>
                </div>
...
<section class="busy-solution py-5 bg-white">
    ...
    <div class="container text-center">
        ...
        <div class="busy-intro-video">
            <iframe
                src="https://www.youtube.com/embed/2QuYJSqzyNM"
                allowfullscreen>
            </iframe>
        </div>
        ...
        <h4 class="busy-testimonial-title">
            Tally Software DEMO Videos – See Tally in Action
        </h4>
        ...
        <div class="busy-video-row">
            ...
            <div class="busy-video-card">
                <iframe src="https://youtube.com/embed/R3MIQBPySj8" allowfullscreen></iframe>
            </div>

            <div class="busy-video-card">
                <iframe src="https://www.youtube.com/embed/HxXNyxj7PJ8" allowfullscreen></iframe>
            </div>

            <div class="busy-video-card">
                <iframe src="https://www.youtube.com/embed/2QuYJSqzyNM" allowfullscreen></iframe>
            </div>
        ...
        <h2 class="busy-main-title">
            TALLY – An Accounting Solution For Everyone
        </h2>

        <p class="busy-main-desc">
            Tally accounting software helps small and medium businesses and caters to a wide
