    ...
    <div class="container">
                ...
                <div class="text-center mt-5 mb-3">
                    <h3 class="finance-title">
                        Benefits of  {{ $softwarecompinfo->software_firm_name }}  Software
                    </h3>
                </div>
                ...
                <div class="finance-row">
                    ...
                    <div>
                        <a href="#" class="finance-link">
                            Hands-On Experience with {{ $softwarecompinfo->software_firm_name }} Features
                        </a>
                        <p>
                            Explore core {{ $softwarecompinfo->software_firm_name }} features and understand real-world accounting workflows.
                        </p>
                    </div>
                </div>
...
<section class="optimize-finance">
    ...
    <div class="container text-center mb-5">
        <h2 class="optimize-title">
            Why {{ $softwarecompinfo->software_firm_name }} Software
        </h2>
    </div>
...
<section class="busy-solution py-5 bg-white">
    ...
    <div class="container text-center">
        ...
        <h3 class="busy-intro-title">
            Watch the {{ $softwarecompinfo->software_firm_name }} Introduction – #1 GST Accounting Software
        </h3>

        <!-- INTRO VIDEO -->
        <div class="busy-intro-video">
            <iframe
                src="https://www.youtube.com/embed/Mu9V0OEoHBs"
                allowfullscreen>
            </iframe>
        </div>
        ...
        <h4 class="busy-testimonial-title">
            {{ $softwarecompinfo->software_firm_name }} Software DEMO Videos – See {{ $softwarecompinfo->software_firm_name }} in Action
        </h4>
        ...
        <div class="busy-video-row">
            ...
            <div class="busy-video-card">
                <iframe src="https://youtube.com/embed/fsTeXSzD6O0" allowfullscreen></iframe>
            </div>

            <div class="busy-video-card">
                <iframe src="https://www.youtube.com/embed/JCbkYoP8i_c" allowfullscreen></iframe>
            </div>

            <div class="busy-video-card">
                <iframe src="https://www.youtube.com/embed/byosySLxZVg" allowfullscreen></iframe>
            </div>

        </div>
        <!-- MAIN HEADING -->
        <h2 class="busy-main-title">
            {{ $softwarecompinfo->software_firm_name }} – An Accounting Solution For Everyone
        </h2>

        <p class="busy-main-desc">
            {{ $softwarecompinfo->software_firm_name }} accounting software helps small and medium businesses and caters to a wide
        ...
        <div class="busy-explore">
            ...
            <div class="busy-card">
                ...
                <h6>{{ $softwarecompinfo->software_firm_name }} Mobile</h6>
                <a href="#" class="busy-btn">VIEW PLAN</a>
            </div>

            <div class="busy-card">
                <i class="fa fa-globe"></i>
                <h6>{{ $softwarecompinfo->software_firm_name }} Online</h6>
                <a href="#" class="busy-btn">VIEW PLAN</a>
            </div>

            <div class="busy-card">
                <i class="fa fa-shopping-bag"></i>
                <h6>{{ $softwarecompinfo->software_firm_name }} Recom</h6>
                <a href="#" class="busy-btn">VIEW PLAN</a>
            </div>
