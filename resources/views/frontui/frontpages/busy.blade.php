        ...
        <div class="row mb-4">
            <div class="col-12 text-center">
                <h2 class="finance-title">
                    Who is BUSY Best Suited For?
                </h2>
                <p class="finance-subtitle">
                    BUSY  is ideal for users who want to experience accounting
                    software features .
                </p>
            </div>
        </div>
            ...
            <div class="col-md-10">
                ...
                <div class="finance-row">
                    ...
                    <div>
                        ...
                        <p>
                            Perfect for small businesses with limited voucher requirements –
                            supports up to <strong>100 vouchers</strong>.
                        </p>
                    </div>
                </div>
                ...
                <div class="finance-row">
                    ...
                    <div>
                        ...
                        <p>
                            Ideal for businesses that don’t want to spend on paid accounting software.
                        </p>
                    </div>
                </div>
                ...
                <div class="finance-row">
                    ...
                    <div>
                        ...
                        <p>
                            Best suited for students who want to learn accounting and software usage.
                        </p>
                    </div>
                </div>
                ...
                <div class="finance-row">
                    ...
                    <div>
                        <a href="#" class="finance-link">
                            Hands-On Experience with BUSY Features
                        </a>
                        <p>
                            Explore core BUSY features and understand real-world accounting workflows.
                        </p>
                    </div>
                </div>
...
<section class="busy-solution py-5 bg-white">
    ...
    <div class="container text-center">
        ...
        <h4 class="busy-testimonial-title">
            Hear What Our Customers Have to Say About BUSY
        </h4>
        ...
        <div class="busy-video-row">
            ...
            <div class="busy-video-card">
                <iframe
                    src="https://youtube.com/embed/s_WOEcK304w"
                    allowfullscreen>
                </iframe>
            </div>
            <div class="busy-video-card">
                <iframe
                    src="https://www.youtube.com/embed/GEYnUClGUW4"
                    allowfullscreen>
                </iframe>
            </div>
            <div class="busy-video-card">
                <iframe
                    src="https://www.youtube.com/embed/-BDT15dfpCg"
                    allowfullscreen>
                </iframe>
            </div>
        ...
        <p class="busy-main-desc">
            BUSY accounting software helps small and medium businesses and caters to a wide
