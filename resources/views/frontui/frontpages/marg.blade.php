...
<section class="financial-process py-5 bg-white">
    <div class="container">
                ...
                <div class="finance-row">
                    ...
                    <div>
                        <a href="#" class="finance-link">
                            Hands-On Experience with MARG Features
                        </a>
                        <p>
                            Explore core MARG features and understand real-world accounting workflows.
                        </p>
                    </div>
                </div>
...
<section class="busy-solution py-5 bg-white">
    ...
    <div class="container text-center">
        ...
        <h4 class="busy-testimonial-title">
            MARG Software DEMO Videos – See MARG in Action
        </h4>
        ...
        <h2 class="busy-main-title">
            MARG – An Accounting Solution For Everyone
        </h2>

        <p class="busy-main-desc">
            MARG accounting software helps small and medium businesses and caters to a wide
