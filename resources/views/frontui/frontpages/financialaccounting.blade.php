...
<section class="optimize-finance">
    ...
    <div class="container text-center mb-5">
        <h2 class="optimize-title">
            Optimize Your Financial Operations With
            {{ $softwarecompinfo->software_firm_name }} Financial Accounting Software
        </h2>
    </div>
    ...
    <div class="optimize-block bg-soft">
        <div class="container">
            <div class="row align-items-center">
                ...
                <!-- CONTENT -->
                <div class="col-md-6">
                    <h4 class="optimize-heading">Ease in Collaboration</h4>
                    <ul class="optimize-list">
                        <li>Collaborate effortlessly with Busy’s cloud accounting software</li>
                        <li>Real-time access to data without USB drives</li>
                        <li>Multiple users can work simultaneously with customizable access levels</li>
                    </ul>
    ...
    <div class="optimize-block">
        <div class="container">
            <div class="row align-items-center flex-md-row-reverse">
                ...
                <!-- CONTENT -->
                <div class="col-md-6">
                    <h4 class="optimize-heading">Improved Data Security</h4>
                    <ul class="optimize-list">
                        <li>Data is securely stored and protected with Busy’s advanced solution</li>
                        <li>No more manual backups or worries about data loss</li>
                        <li>Stay up-to-date with automatic synchronization</li>
                    </ul>
                    <a href="{{ url('/freetrial') }}" class="btn optimize-btn">
                        Try Busy for Free
                    </a>
    ...
    <div class="optimize-block bg-soft">
        <div class="container">
            <div class="row align-items-center">
                ...
                <!-- CONTENT -->
                <div class="col-md-6">
                    <h4 class="optimize-heading">Increased Accounting Accuracy</h4>
                    <ul class="optimize-list">
                        <li>Avoid common accounting errors with Busy’s online software</li>
                        <li>Alerts for unbalanced entries ensure accurate data organisation</li>
                        <li>No data inconsistency or merging issues with automatic syncing</li>
                    </ul>
                    <a href="{{ url('/freetrial') }}" class="btn optimize-btn">
                        Try Busy for Free
                    </a>
    ...
    <div class="optimize-block">
        <div class="container">
            <div class="row align-items-center flex-md-row-reverse">
                ...
                <!-- CONTENT -->
                <div class="col-md-6">
                    <h4 class="optimize-heading">Customisation and Extensibility</h4>
                    <ul class="optimize-list">
                        <li>Flexible and customizable platform</li>
                        <li>Customized forms, reports, and workflows</li>
                        <li>Tailored financial accounting solution for growing businesses</li>
                    </ul>
                    <a href="{{ url('/freetrial') }}" class="btn optimize-btn">
                        Try Busy for Free
                    </a>
