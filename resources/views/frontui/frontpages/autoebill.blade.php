...
<section class="optimize-finance">
    ...
    Optimize E-Way Bill Compliance With
    {{ $softwarecompinfo->software_firm_name }} E-Way Bill Software
</h2>
   ...
   <div class="optimize-block bg-soft">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <h4 class="optimize-heading">Time and Cost Savings</h4>
                <ul class="optimize-list">
                    <li>Automates the billing process</li>
                    <li>Reduces manual errors and saves time</li>
                    <li>Lowers the admin costs with manual paperwork</li>
                </ul>
   ...
   <div class="optimize-block">
    <div class="container">
        <div class="row align-items-center flex-md-row-reverse">
            ...
            <div class="col-md-6">
                <h4 class="optimize-heading">Complete Compliance With GST Norms</h4>
                <ul class="optimize-list">
                    <li>Ensure compliance with government regulations</li>
                    <li>Generate accurate e-way bills in the required format</li>
                    <li>Minimise risk of non-compliance penalties</li>
                </ul>
                <a href="{{ url('/freetrial') }}" class="btn optimize-btn">
                    Try Busy for Free
                </a>
   ...
   <div class="optimize-block bg-soft">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <h4 class="optimize-heading">Enhanced Logistics Operations</h4>
                <ul class="optimize-list">
                    <li>Enhances efficiency in logistics operations</li>
                    <li>Seamless e-way bill generation & management</li>
                    <li>Eliminates manual paperwork saving time & effort</li>
                </ul>
                <a href="{{ url('/freetrial') }}" class="btn optimize-btn">
                    Try Busy for Free
                </a>
  ...
  <div class="optimize-block">
    <div class="container">
        <div class="row align-items-center flex-md-row-reverse">
            ...
            <div class="col-md-6">
                <h4 class="optimize-heading">Faster & Error-Free Processing</h4>
                <ul class="optimize-list">
                    <li>Quick e-way bill generation with minimal data entry</li>
                    <li>Automatic validation reduces chances of errors</li>
                    <li>Improves overall operational efficiency</li>
                </ul>
                <a href="{{ url('/freetrial') }}" class="btn optimize-btn">
                    Try Busy for Free
                </a>
