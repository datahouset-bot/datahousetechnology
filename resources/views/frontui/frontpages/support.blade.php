...
<section class="busy-support-section">
    <div class="container">
        <div class="row align-items-center">

            <!-- LEFT -->
            <div class="col-md-8">
                <h3 class="busy-support-title">
                    Need Help or Support?
                </h3>
                <p class="busy-support-desc">
                    Our experts are ready to help you with demo, setup, GST queries and technical support.
                </p>
            </div>

            <!-- RIGHT -->
            <div class="col-md-4">
                <div class="busy-support-box">

                    @if(!empty($softwarecompinfo->software_mobile))
                        <a href="tel:{{ $softwarecompinfo->software_mobile }}" class="support-item">
                            <i class="fa fa-phone"></i>
                            <span>{{ $softwarecompinfo->software_mobile }}</span>
                        </a>
                    @endif

                    @if(!empty($softwarecompinfo->software_phone))
                        <a href="tel:{{ $softwarecompinfo->software_phone }}" class="support-item">
                            <i class="fa fa-headphones"></i>
                            <span>{{ $softwarecompinfo->software_phone }}</span>
                        </a>
                    @endif

                    @if(!empty($softwarecompinfo->software_email))
                        <a href="mailto:{{ $softwarecompinfo->software_email }}" class="support-item">
                            <i class="fa fa-envelope"></i>
                            <span>{{ $softwarecompinfo->software_email }}</span>
                        </a>
                    @endif

                    @if(!empty($softwarecompinfo->software_whatsapp))
                        <a href="https://wa.me/{{ preg_replace('/\D/', '', $softwarecompinfo->software_whatsapp) }}"
                           target="_blank"
                           class="support-item whatsapp">
...
<section class="busy-solution py-5 bg-white">
    ...
    <div class="container text-center">
        ...
        <h3 class="busy-intro-title">
            Watch the BUSY Introduction – #1 GST Accounting Software
        </h3>

        <!-- INTRO VIDEO -->
        <div class="busy-intro-video">
            <iframe
                src="https://www.youtube.com/embed/JZjy7M2-5cA"
                allowfullscreen>
            </iframe>
        </div>
        ...
        <h4 class="busy-testimonial-title">
            Speed Plus Software DEMO Videos – See Speed Plus in Action
        </h4>
        ...
        <div class="busy-video-row">
            ...
            <div class="busy-video-card">
                <iframe src="https://youtube.com/embed/tUNpeEHwK4o" allowfullscreen></iframe>
            </div>

            <div class="busy-video-card">
                <iframe src="https://www.youtube.com/embed/FV1dG-OOWYs" allowfullscreen></iframe>
            </div>

            <div class="busy-video-card">
                <iframe src="https://www.youtube.com/embed/Pf82dUMy3s4" allowfullscreen></iframe>
            </div>
        ...
        <h2 class="busy-main-title">
            Speed Plus – An Accounting Solution For Everyone
        </h2>

        <p class="busy-main-desc">
            Speed Plus accounting software helps small and medium businesses and caters to a wide
        ...
        <div class="busy-explore">
            ...
            <div class="busy-card">
                ...
                <h6>Speed Plus Mobile</h6>
                <a href="#" class="busy-btn">VIEW PLAN</a>
            </div>

            <div class="busy-card">
                <i class="fa fa-globe"></i>
                <h6>Speed Plus Online</h6>
                <a href="#" class="busy-btn">VIEW PLAN</a>
            </div>

            <div class="busy-card">
                <i class="fa fa-shopping-bag"></i>
                <h6>Speed Plus Recom</h6>
                <a href="#" class="busy-btn">VIEW PLAN</a>
            </div>
