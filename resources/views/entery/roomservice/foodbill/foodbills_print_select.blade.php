                                            ...
                                            <div class="col-md-12 mt-5">
                                                <form class="form-inline" id="select_roomcheckout">
                                                    ...
                                                    <div class="input-group">
                                                        <select name="print_format" id="print_format" class="form-select" aria-label="Default select example">
                                                            <option value="" selected disabled>Select Print Format</option>
                                                            @foreach ($fromtlist as $record)
                                                                <option value="{{ $record->option_name }}/{{ $voucher_no }}">
                                                                    {{ $record->format_name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <script>
                                                    document.getElementById('print_format').addEventListener('change', function () {
                                                        ...
                                                        if (voucherNo) {
                                                            // Assuming the base URL is available as a JavaScript variable or dynamically
                                                            var baseUrl = "{{ url('/') }}"; // Laravel's helper to get the base URL
                                                            window.location.href = baseUrl + "/" + voucherNo;
                                                        }
                                                    });
                                                </script>
                                            </div>
